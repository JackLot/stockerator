...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { cash: @individual.cash, investable_id: @individual.investable_id, name: @individual.name }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { cash: @individual.cash, investable_id: @individual.investable_id, name: @individual.name }
    assert_redirected_to individual_path(assigns(:individual))
  end
